...
locals {
  ...
  # "team-tools" is the Service tag of the team's own tools, whose role is
  # generated by tools-role: a service of that name would share its tag, and so
  # its permissions.
  reserved_service_names = ["database", "database-hub", "fleet", "internal", "platform", "private", "services", "team-tools"]
